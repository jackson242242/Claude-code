...
const FIXTURES: Fixture[] = [
  ...
  { matchNumber: 5, stage: 'Group Stage', group: 'B', homeTeam: 'Qatar', awayTeam: 'Switzerland', venueId: 'san-francisco', date: '2026-06-13', time: '12:00' },
  { matchNumber: 6, stage: 'Group Stage', group: 'C', homeTeam: 'Brazil', awayTeam: 'Morocco', venueId: 'new-york', date: '2026-06-13', time: '18:00' },
  { matchNumber: 7, stage: 'Group Stage', group: 'C', homeTeam: 'Haiti', awayTeam: 'Scotland', venueId: 'boston', date: '2026-06-13', time: '21:00' },
  { matchNumber: 8, stage: 'Group Stage', group: 'D', homeTeam: 'Australia', awayTeam: 'Turkey', venueId: 'vancouver', date: '2026-06-13', time: '21:00' },
  { matchNumber: 9, stage: 'Group Stage', group: 'E', homeTeam: 'Germany', awayTeam: 'Curaçao', venueId: 'houston', date: '2026-06-14', time: '12:00' },
  { matchNumber: 10, stage: 'Group Stage', group: 'F', homeTeam: 'Netherlands', awayTeam: 'Japan', venueId: 'dallas', date: '2026-06-14', time: '15:00' },
  { matchNumber: 11, stage: 'Group Stage', group: 'E', homeTeam: 'Ivory Coast', awayTeam: 'Ecuador', venueId: 'philadelphia', date: '2026-06-14', time: '19:00' },
  { matchNumber: 12, stage: 'Group Stage', group: 'F', homeTeam: 'Sweden', awayTeam: 'Tunisia', venueId: 'monterrey', date: '2026-06-14', time: '20:00' },
  { matchNumber: 13, stage: 'Group Stage', group: 'H', homeTeam: 'Spain', awayTeam: 'Cape Verde', venueId: 'atlanta', date: '2026-06-15', time: '12:00' },
  { matchNumber: 14, stage: 'Group Stage', group: 'G', homeTeam: 'Belgium', awayTeam: 'Egypt', venueId: 'seattle', date: '2026-06-15', time: '12:00' },
  { matchNumber: 15, stage: 'Group Stage', group: 'H', homeTeam: 'Saudi Arabia', awayTeam: 'Uruguay', venueId: 'miami', date: '2026-06-15', time: '18:00' },
  { matchNumber: 16, stage: 'Group Stage', group: 'G', homeTeam: 'Iran', awayTeam: 'New Zealand', venueId: 'los-angeles', date: '2026-06-15', time: '18:00' },
  ...
  { matchNumber: 21, stage: 'Group Stage', group: 'K', homeTeam: 'Portugal', awayTeam: 'DR Congo', venueId: 'houston', date: '2026-06-17', time: '12:00' },
  { matchNumber: 22, stage: 'Group Stage', group: 'L', homeTeam: 'England', awayTeam: 'Croatia', venueId: 'dallas', date: '2026-06-17', time: '15:00' },
  { matchNumber: 23, stage: 'Group Stage', group: 'L', homeTeam: 'Ghana', awayTeam: 'Panama', venueId: 'toronto', date: '2026-06-17', time: '19:00' },
  ...
  { matchNumber: 29, stage: 'Group Stage', group: 'D', homeTeam: 'USA', awayTeam: 'Australia', venueId: 'seattle', date: '2026-06-19', time: '12:00' },
  { matchNumber: 30, stage: 'Group Stage', group: 'C', homeTeam: 'Scotland', awayTeam: 'Morocco', venueId: 'boston', date: '2026-06-19', time: '18:00' },
  { matchNumber: 31, stage: 'Group Stage', group: 'C', homeTeam: 'Brazil', awayTeam: 'Haiti', venueId: 'philadelphia', date: '2026-06-19', time: '20:30' },
  { matchNumber: 32, stage: 'Group Stage', group: 'D', homeTeam: 'Turkey', awayTeam: 'Paraguay', venueId: 'san-francisco', date: '2026-06-19', time: '20:00' },
  { matchNumber: 33, stage: 'Group Stage', group: 'F', homeTeam: 'Netherlands', awayTeam: 'Sweden', venueId: 'houston', date: '2026-06-20', time: '12:00' },
  { matchNumber: 34, stage: 'Group Stage', group: 'E', homeTeam: 'Germany', awayTeam: 'Ivory Coast', venueId: 'toronto', date: '2026-06-20', time: '16:00' },
  { matchNumber: 35, stage: 'Group Stage', group: 'E', homeTeam: 'Ecuador', awayTeam: 'Curaçao', venueId: 'kansas-city', date: '2026-06-20', time: '19:00' },
  { matchNumber: 36, stage: 'Group Stage', group: 'F', homeTeam: 'Tunisia', awayTeam: 'Japan', venueId: 'monterrey', date: '2026-06-20', time: '22:00' },
  { matchNumber: 37, stage: 'Group Stage', group: 'H', homeTeam: 'Spain', awayTeam: 'Saudi Arabia', venueId: 'atlanta', date: '2026-06-21', time: '12:00' },
  { matchNumber: 38, stage: 'Group Stage', group: 'G', homeTeam: 'Belgium', awayTeam: 'Iran', venueId: 'los-angeles', date: '2026-06-21', time: '12:00' },
  { matchNumber: 39, stage: 'Group Stage', group: 'H', homeTeam: 'Uruguay', awayTeam: 'Cape Verde', venueId: 'miami', date: '2026-06-21', time: '18:00' },
  ...
  { matchNumber: 41, stage: 'Group Stage', group: 'J', homeTeam: 'Argentina', awayTeam: 'Austria', venueId: 'dallas', date: '2026-06-22', time: '12:00' },
  { matchNumber: 42, stage: 'Group Stage', group: 'I', homeTeam: 'France', awayTeam: 'Iraq', venueId: 'philadelphia', date: '2026-06-22', time: '17:00' },
  { matchNumber: 43, stage: 'Group Stage', group: 'I', homeTeam: 'Norway', awayTeam: 'Senegal', venueId: 'new-york', date: '2026-06-22', time: '20:00' },
  ...
  { matchNumber: 45, stage: 'Group Stage', group: 'K', homeTeam: 'Portugal', awayTeam: 'Uzbekistan', venueId: 'houston', date: '2026-06-23', time: '12:00' },
  { matchNumber: 46, stage: 'Group Stage', group: 'L', homeTeam: 'England', awayTeam: 'Ghana', venueId: 'boston', date: '2026-06-23', time: '16:00' },
  { matchNumber: 47, stage: 'Group Stage', group: 'L', homeTeam: 'Panama', awayTeam: 'Croatia', venueId: 'toronto', date: '2026-06-23', time: '19:00' },
  ...
  { matchNumber: 49, stage: 'Group Stage', group: 'B', homeTeam: 'Bosnia & Herzegovina', awayTeam: 'Qatar', venueId: 'seattle', date: '2026-06-24', time: '12:00' },
  { matchNumber: 50, stage: 'Group Stage', group: 'B', homeTeam: 'Switzerland', awayTeam: 'Canada', venueId: 'vancouver', date: '2026-06-24', time: '12:00' },
  { matchNumber: 51, stage: 'Group Stage', group: 'C', homeTeam: 'Morocco', awayTeam: 'Haiti', venueId: 'atlanta', date: '2026-06-24', time: '18:00' },
  { matchNumber: 52, stage: 'Group Stage', group: 'C', homeTeam: 'Scotland', awayTeam: 'Brazil', venueId: 'miami', date: '2026-06-24', time: '18:00' },
  ...
  { matchNumber: 59, stage: 'Group Stage', group: 'D', homeTeam: 'Paraguay', awayTeam: 'Australia', venueId: 'san-francisco', date: '2026-06-25', time: '19:00' },
  { matchNumber: 60, stage: 'Group Stage', group: 'D', homeTeam: 'Turkey', awayTeam: 'USA', venueId: 'los-angeles', date: '2026-06-25', time: '19:00' },
  ...
  { matchNumber: 63, stage: 'Group Stage', group: 'H', homeTeam: 'Cape Verde', awayTeam: 'Saudi Arabia', venueId: 'houston', date: '2026-06-26', time: '19:00' },
  { matchNumber: 64, stage: 'Group Stage', group: 'H', homeTeam: 'Uruguay', awayTeam: 'Spain', venueId: 'guadalajara', date: '2026-06-26', time: '18:00' },
  { matchNumber: 65, stage: 'Group Stage', group: 'G', homeTeam: 'Egypt', awayTeam: 'Iran', venueId: 'seattle', date: '2026-06-26', time: '20:00' },
  { matchNumber: 66, stage: 'Group Stage', group: 'G', homeTeam: 'New Zealand', awayTeam: 'Belgium', venueId: 'vancouver', date: '2026-06-26', time: '20:00' },
  { matchNumber: 67, stage: 'Group Stage', group: 'L', homeTeam: 'Croatia', awayTeam: 'Ghana', venueId: 'philadelphia', date: '2026-06-27', time: '17:00' },
  { matchNumber: 68, stage: 'Group Stage', group: 'L', homeTeam: 'Panama', awayTeam: 'England', venueId: 'new-york', date: '2026-06-27', time: '17:00' },
  { matchNumber: 69, stage: 'Group Stage', group: 'K', homeTeam: 'Colombia', awayTeam: 'Portugal', venueId: 'miami', date: '2026-06-27', time: '19:30' },
  { matchNumber: 70, stage: 'Group Stage', group: 'K', homeTeam: 'DR Congo', awayTeam: 'Uzbekistan', venueId: 'atlanta', date: '2026-06-27', time: '19:30' },
  { matchNumber: 71, stage: 'Group Stage', group: 'J', homeTeam: 'Algeria', awayTeam: 'Austria', venueId: 'kansas-city', date: '2026-06-27', time: '21:00' },
  { matchNumber: 72, stage: 'Group Stage', group: 'J', homeTeam: 'Jordan', awayTeam: 'Argentina', venueId: 'dallas', date: '2026-06-27', time: '21:00' },
  ...
  { matchNumber: 82, stage: 'Round of 32', group: null, homeTeam: 'Winner Group G', awayTeam: '3rd: A/E/H/I/J', venueId: 'seattle', date: '2026-07-01', time: '12:00' },
