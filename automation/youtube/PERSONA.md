...
- **内容重心（owner 2026-08-09）：古文化产物优先** —— 建筑、历史、传统风俗这些
  ...
  亲子（带孩子了解中国文化的趣味讲解）。
- **内容重心 v2（owner 2026-09-26，覆盖上一条）：走出大城市 → 小城市 + 山川地貌。**
  山里、沙漠、湖泊，丹霞/喀斯特/梯田/盐湖/峡谷这些地貌和特别的自然风光，加上古镇小城。
  北京/上海/广州/深圳/重庆/杭州/成都/西安这类大城市不再当主角，只作出发点
  （"4 hours from Shanghai"）或价格对照。古文化产物降为配角，只在小城或山野场景里
  出现（悬崖石刻、山中寺院、村寨手艺），不再做单独的手艺卡/大城市古迹卡。
  一句话定位：*"Beyond the big cities — China's mountains, deserts and small towns,
  with real prices."* 签名块、开场句、角标不变；频道描述/歌单描述在下一次元数据
  轮次同步（§8 待办）。素材真值表与选题池：`plans/nature-pivot.md`。
- 记忆点签名（三件套，处处出现）：
...
## 6. 赚流量打法（上载策略）
1. **节奏**：4 条/天 @13/17/20/23Z（owner 2026-08-10: 欧美受众定制——EU 下午/傍晚黄金档 + 美东早晚黄金档）；连载 + 系列歌单 = 追剧结构
