...
CITIES: list[dict[str, Any]] = [
    {"id": "mexico-city", "name": "Mexico City", "country": "Mexico", "lat": 19.303, "lng": -99.15, "airports": ["MEX", "NLU"], "transport_notes": "Metro Línea 2 and Metrobús connect central Mexico City to Estadio Azteca in the south."},
    {"id": "guadalajara", "name": "Guadalajara", "country": "Mexico", "lat": 20.681, "lng": -103.463, "airports": ["GDL"], "transport_notes": "Mi Macro Periférico bus rapid transit and rideshare serve Estadio Akron in Zapopan."},
    {"id": "monterrey", "name": "Monterrey", "country": "Mexico", "lat": 25.669, "lng": -100.244, "airports": ["MTY"], "transport_notes": "Rideshare and event shuttles are the main options to Estadio BBVA in Guadalupe."},
    {"id": "atlanta", "name": "Atlanta", "country": "USA", "lat": 33.755, "lng": -84.401, "airports": ["ATL"], "transport_notes": "MARTA rail links Hartsfield-Jackson airport directly to Mercedes-Benz Stadium downtown."},
    {"id": "boston", "name": "Boston", "country": "USA", "lat": 42.091, "lng": -71.264, "airports": ["BOS"], "transport_notes": "Special-event commuter rail runs from Boston South Station to Foxborough on match days."},
    {"id": "dallas", "name": "Dallas", "country": "USA", "lat": 32.747, "lng": -97.093, "airports": ["DFW", "DAL"], "transport_notes": "No rail to Arlington; use event shuttles or rideshare from Dallas and Fort Worth."},
    ...
    {"id": "los-angeles", "name": "Los Angeles", "country": "USA", "lat": 33.953, "lng": -118.339, "airports": ["LAX"], "transport_notes": "Metro K Line and shuttles serve SoFi Stadium in Inglewood, close to LAX."},
    {"id": "miami", "name": "Miami", "country": "USA", "lat": 25.958, "lng": -80.239, "airports": ["MIA", "FLL"], "transport_notes": "Tri-Rail plus event shuttles connect to Hard Rock Stadium in Miami Gardens."},
    ...
    {"id": "philadelphia", "name": "Philadelphia", "country": "USA", "lat": 39.901, "lng": -75.168, "airports": ["PHL"], "transport_notes": "SEPTA Broad Street Line runs directly to the South Philadelphia stadium complex."},
    ...
    {"id": "vancouver", "name": "Vancouver", "country": "Canada", "lat": 49.277, "lng": -123.112, "airports": ["YVR"], "transport_notes": "SkyTrain connects YVR airport to BC Place in downtown Vancouver."},
]
