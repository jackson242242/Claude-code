...
function eyes(cx: number): string {
...
function wrap(inner: string): string {
  // width/height 100% so the parent container controls the rendered size
  return `<svg class="mascot" viewBox="0 0 200 200" style="width:100%;height:100%;display:block" xmlns="http://www.w3.org/2000/svg">${inner}</svg>`;
}

export function mascotSVG(stage: number, prog = 0): string {
  switch (stage) {
    case 0: {
      ...
      return wrap(`<ellipse cx="100" cy="112" rx="56" ry="70" fill="#f6e7c5" stroke="#d8b878" stroke-width="4"/>
        <ellipse cx="82" cy="88" rx="16" ry="22" fill="#fff" opacity=".35"/>${cracks}`);
    }
    case 1:
      return wrap(`<g transform="translate(100,118)">
    ...
    case 2:
      return wrap(`<g transform="translate(100,108)">
    ...
    case 3:
      return wrap(`<g transform="translate(100,96)">
    ...
    default:
      return wrap(`<g transform="translate(100,78)">
