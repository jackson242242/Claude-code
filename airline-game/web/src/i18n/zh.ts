...
const zh = {
  ...
  // ── S5 多人房间失效兜底 ──────────────────────────────────────────────────
  'match.room.expired': '多人房间已失效（服务器可能已重启），请返回主菜单新建或加入房间。',

  // ── S2 冷启动友好态 ──────────────────────────────────────────────────────
  'server.waking': '正在唤醒服务器…（免费实例休眠中，约需 30 秒，请稍候）',

  // ── S4 错误边界 ──────────────────────────────────────────────────────────
  'boundary.title': '哎呀，出了点状况',
  'boundary.body': '游戏遇到一个意外错误。点下面的按钮重开一局即可，存档不受影响。',
  'boundary.restart': '重开一局',
} as const;
