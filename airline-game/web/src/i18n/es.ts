...
const es: Dict = {
  ...
  // ── V3.3 Multiplayer ──────────────────────────────────────────────────────
  'mode.select.heading': 'Elegir modo de juego',
  'mode.select.solo': 'Un jugador',
  ...
  'match.create.fillWithAI': 'Completar con IA si hay huecos',
  'match.join.heading': 'Unirse a sala',
  'match.join.code.label': 'Código de sala',
  'match.join.code.placeholder': 'Introduce el código de 6 caracteres',
  'match.join.btn': 'Unirse',
  'match.join.btn.joining': 'Uniéndose…',
  'match.back': 'Volver',
  'match.create.btn.creating': 'Creando…',
  'lobby.heading': 'Sala de espera',
  'lobby.code.label': 'Código de sala',
  'lobby.code.copy': 'Copiar',
  'lobby.code.copied': '¡Copiado!',
  'lobby.players.heading': 'Jugadores',
  'lobby.player.ready': 'Listo',
  'lobby.player.waiting': 'Esperando',
  'lobby.player.host': 'Anfitrión',
  'lobby.player.you': '(Tú)',
  'lobby.waiting': 'Esperando que otros jugadores se unan…',
  'lobby.btn.start': 'Iniciar partida',
  'lobby.btn.start.disabled': 'Se necesitan al menos 2 jugadores',
  'lobby.btn.starting': 'Iniciando…',
  'lobby.btn.leave': 'Salir de la sala',
  'match.hud.code': 'Sala: {code}',
  'match.hud.turn': 'Turno {turn}/80',
  'match.hud.ready': '{ready}/{total} listos',
  'match.hud.ready.btn': 'Listo para liquidar',
  'match.hud.ready.done': 'Listo ✓',
  'match.hud.deadline': 'Límite: {s}s',
